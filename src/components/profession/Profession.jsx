  ...
  return (
    ...
    >
      <div className="flex flex-col justify-between h-fit md:pe-8 lg:pe-35.75 max-md:text-center my-auto">
        ...
        <a
          href="#!"
          className="mt-5 md:mt-12.5 btn bg-black text-white w-fit md:py-3 md:px-6 text-[12px] sm:text-[16px] font-semibold hover:bg-neutral-800 max-md:mx-auto max-md:mb-5"
