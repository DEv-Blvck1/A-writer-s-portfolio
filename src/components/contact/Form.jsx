    ...
    <div>
      ...
      <div className="mx-2">
        <form className="flex flex-col gap-4 mt-4" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="btn gap-3 max-lg:mx-auto bg-black text-white rounded-sm mt-5 text-[13px] md:text-[16px] w-fit font-semibold lg:mt-12.5 p-2 md:px-4 hover:bg-gray-800"
          >
            Submit {telegramSVG}
          </button>
